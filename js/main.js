...
function init() {
  ...
  if (iOS) {
    // $('.fixed').css('height','56px');
    $('.title-text').css({'margin-left':'60px','background-size':'auto 50%'});
    // var section = document.getElementsByClassName('title-text');
    // for (var i = 0; i < section.length; i++) {
    //   console.log(section[i]);
    //   section[i].style.cssText = "margin:0;padding:0;padding-left:40px;margin-left:50px;height:50px;line-height:46px;text-align:left;width:90%;background-size:auto 58%";
    // }
    document.getElementsByClassName('menu-bar')[0].style.cssText = "width:60px;height:84px;padding-top:14px;background:none";
  }
  if(!mobile){
    setTimeout(function(){
  ...
  setTimeout(function(){
    document.getElementsByClassName('full-size')[0].style.cssText = "opacity:1";
  },1100);
  ...
  setTimeout(function(){
    document.getElementsByClassName('loading-screen')[0].style.cssText ="opacity:0;pointer-events:none";
    document.getElementsByTagName('html')[0].style.cssText ="overflow-y:auto";
  },100);
